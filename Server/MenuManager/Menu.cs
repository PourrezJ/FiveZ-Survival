...
namespace FiveZ
{
    public class Menu
    {
        ...
        #region Constructor
        public Menu(string id, string title, string subTitle = "", bool backCloseMenu = true, int posX = -34, int posY = 120, MenuAnchor anchor = MenuAnchor.TopRight, bool noExit = false, bool enableBanner = true, Banner banner = null)
        {
            _selectedIndex = -1;
            _selectedItem = null;
