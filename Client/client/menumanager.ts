...
export function initialize() {
    alt.onServer('MenuManager_OpenMenu', (data) => {
        ...
        if (menuData.BannerSprite != undefined) {
            menu = new NativeUI.Menu(menuData.Title, menuData.SubTitle, pos, menuData.BannerSprite.Dict, menuData.BannerSprite.Name);
        } else {
            ...
            if (menuData.BannerColor != undefined) {
                ...
                menu = new NativeUI.Menu(menuData.Title, menuData.SubTitle, pos, undefined, undefined, color);
            } else {
                menu = new NativeUI.Menu(menuData.Title, menuData.SubTitle, pos);
            }
        }
